...
<section id="4">
    <div class="container col-xxl-8 px-2 py-5" >
      ...
      <div class="col-10 col-sm-8 col-lg-6" style="margin:-30px auto;">
          <img src="./Images/Back.gif" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="800" height="800" loading="lazy">
        </div>
      <div class="col-lg-6" style=" font-family:'Playfair Display' "; >
      <div class="box">
        <div class="center-container" style="width:800px; margin:-30px auto;">
        <form action="suggest.php" method="post">
    <label for="restaurant_name" style="text-align: left;">Restaurant Name:</label>
    ...
    <label for="meal" style="text-align: left;">Meal:</label>
    <input type="text" id="meal" name="meal" required><br>

    <label for="review" style="text-align: left;">Review:</label>
    <input type="text" id="review" name="review" required><br>

    <label for="mustry" style="text-align: left;">Mustry:</label>
    <input type="text" id="mustry" name="mustry" required><br>
