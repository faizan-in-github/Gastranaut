      ...
      <div class="navbar">
        <nav>
          <ul>
            ...
            <li><a href="#" class="olcolor">Sign-up</a></li>
          </ul>
        </nav>
      </div>
    </div>
        ...
        <div class="container col-xxl-8 px-2 py-5">
            <div class="row flex-lg-row-reverse align-items-center g-5 py-10">
                ...
                <div class="col-lg-6" style="font-family:'Playfair Display'">
                    <div class="box">
                        <div class="center-container" style="width:300px; margin:0 auto;">
                            ...
                            <?php
                            // Display the login message within the same form
                            if (!empty($loginMessage)) {
                                echo '<div class="login-message">' . $loginMessage . '</div>';
                            }
                            ?>
                        </div>
                    </div>
